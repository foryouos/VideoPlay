...
void VideoDecode::setPosition(qint64 position)
{
    // Calculate the new timestamp based on the position
...
qint64 VideoDecode::getcurrenttime()
{
    // Calculate the current time and total time in seconds
   //qint64 currentTime = m_pts / AV_TIME_BASE;
   return m_obtainFrames;
}

qint64 VideoDecode::gettotaltime()
{

   //qint64 totalTime = m_totalTime / AV_TIME_BASE;
   return m_totalTime;
}
